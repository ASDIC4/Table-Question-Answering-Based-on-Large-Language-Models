...
class Model:
    ...
    #    print(f"input: {input_tokens} tokens, {input_tokens * 0.0005 / 1000} prices")
    ...
    def query_openai(self, 
        ...
        #     messages=messages
        # )
        # print(f"看看临时的response：{response.choices[0].message.content}")
        # # retu
    
        for i in range(64):
            # log
            # print(f"query openai 下的第 {i} 次尝试")
            try:
